...
public class VNPayConfig {
	...
	public static String VNP_RETURNURL = "/mobile/v1/user/guest/payment/vnpay-payment";

	public static String VNP_APIURL = "https://sandbox.vnpayment.vn/merchant_webapi/api/transaction";

	public static String VNP_ORDERTYPE = "25000";
	
	public static String VNP_COMMAND_PAY = "pay";
	
	public static String VNP_CURR_CODE = "VND";
